...
namespace StardustSandbox.Game.Elements.Common.Solid.Movable
{
    ...
    public sealed class SMud : SMovableSolid
    {
        ...
        {
            public SMudItem(SGame gameInstance, SAssetDatabase assetDatabase) : base(gameInstance, assetDatabase)
            {
                this.Identifier = "ELEMENT_MUD";
                this.Name = "Mud";
                this.Description = string.Empty;
                this.Category = "Powders";
                this.IconTexture = assetDatabase.GetTexture("icon_element_2");
                this.IsVisible = true;
