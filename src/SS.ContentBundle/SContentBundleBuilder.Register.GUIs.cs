using StardustSandbox.ContentBundle.GUISystem.GUIs.Debug;
...
namespace StardustSandbox.ContentBundle
{
    public sealed partial class SContentBundleBuilder
    {
        ...
        {
            SGUI_TextDebug textDebug = new(game, SGUIConstants.MAIN_MENU_IDENTIFIER, game.GUIManager.GUIEvents);
