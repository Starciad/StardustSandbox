...
namespace StardustSandbox.ContentBundle.GUISystem.GUIs.Menus.Play
{
    internal partial class SGUI_PlayMenu : SGUISystem
    {
        ...
        internal SGUI_PlayMenu(ISGame gameInstance, string identifier, SGUIEvents guiEvents) : base(gameInstance, identifier, guiEvents)
        {
            ...
            this.returnIconTexture = gameInstance.AssetDatabase.GetTexture("texture_icon_gui_16");
            this.worldIconTexture = gameInstance.AssetDatabase.GetTexture("texture_icon_gui_17");
