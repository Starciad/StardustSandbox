...
namespace StardustSandbox.Core.GUISystem.GUIs.Menus.Credits
{
    internal sealed partial class SGUI_CreditsMenu : SGUISystem
    {
        ...
        {
            this.gameTitleTexture = gameInstance.AssetDatabase.GetTexture("texture_game_title_1");
            this.starciadCharacterTexture = gameInstance.AssetDatabase.GetTexture("texture_character_1");
            this.monogameLogoTexture = gameInstance.AssetDatabase.GetTexture("texture_third_party_1");
            this.xnaLogoTexture = gameInstance.AssetDatabase.GetTexture("texture_third_party_2");
