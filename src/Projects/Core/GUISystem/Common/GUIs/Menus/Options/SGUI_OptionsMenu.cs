...
using StardustSandbox.Core.GUISystem.Common.Elements;
...
using StardustSandbox.Core.GUISystem.Common.GUIs.Menus.Options.Structure;
...
namespace StardustSandbox.Core.GUISystem.GUIs.Menus.Options
{
    internal sealed partial class SGUI_OptionsMenu : SGUISystem
    {
        ...
        internal SGUI_OptionsMenu(ISGame gameInstance, string identifier, SGUIEvents guiEvents, SGUI_ColorPicker guiColorPicker, SGUI_Message guiMessage, SGUITooltipBoxElement tooltipBoxElement) : base(gameInstance, identifier, guiEvents)
        {
            ...
            this.toggleButtonTexture = gameInstance.AssetDatabase.GetTexture("texture_gui_button_5");
            this.plusIconTexture = gameInstance.AssetDatabase.GetTexture("texture_icon_gui_51");
            this.minusIconTexture = gameInstance.AssetDatabase.GetTexture("texture_icon_gui_52");
            this.panelBackgroundTexture = gameInstance.AssetDatabase.GetTexture("texture_gui_background_13");
            this.colorButtonTexture = gameInstance.AssetDatabase.GetTexture("texture_gui_button_4");
