...
using StardustSandbox.Core.GUISystem.Common.Global;
...
using StardustSandbox.Core.Localization.WorldTools;
using StardustSandbox.Core.Mathematics.Primitives;
using StardustSandbox.Core.GUISystem.GUIs.Tools.Confirm;

using System;

namespace StardustSandbox.Core.GUISystem.GUIs.Hud
{
    internal sealed partial class SGUI_HUD : SGUISystem
    {
        ...
        internal SGUI_HUD(ISGame gameInstance, string identifier, SGUIEvents guiEvents, SGUI_Confirm guiConfirm, SGUITooltipBoxElement tooltipBoxElement) : base(gameInstance, identifier, guiEvents)
        {
            ...
            this.guiButtonTexture = this.SGameInstance.AssetDatabase.GetTexture("texture_gui_button_1");

            this.guiVerticalBackgroundTexture = this.SGameInstance.AssetDatabase.GetTexture("texture_gui_background_15");
            this.guiHorizontalBackgroundTexture = this.SGameInstance.AssetDatabase.GetTexture("texture_gui_background_16");
            this.guiHorizontalDrawerButtonsTexture = this.SGameInstance.AssetDatabase.GetTexture("texture_gui_button_6");
            this.guiVerticalDrawerButtonsTexture = this.SGameInstance.AssetDatabase.GetTexture("texture_gui_button_7");

            this.magnifyingGlassIconTexture = this.SGameInstance.AssetDatabase.GetTexture("texture_icon_gui_1");
            this.trashIconTexture = this.SGameInstance.AssetDatabase.GetTexture("texture_icon_gui_2");
            this.reloadIconTexture = this.SGameInstance.AssetDatabase.GetTexture("texture_icon_gui_5");
            this.menuIconTexture = this.SGameInstance.AssetDatabase.GetTexture("texture_icon_gui_6");
            this.saveIconTexture = this.SGameInstance.AssetDatabase.GetTexture("texture_icon_gui_7");
            this.pauseIconTexture = this.SGameInstance.AssetDatabase.GetTexture("texture_icon_gui_8");
            this.resumeIconTexture = this.SGameInstance.AssetDatabase.GetTexture("texture_icon_gui_9");
            this.pencilIconTexture = this.SGameInstance.AssetDatabase.GetTexture("texture_icon_gui_10");
            this.weatherIconTexture = this.SGameInstance.AssetDatabase.GetTexture("texture_icon_gui_11");
            this.settingsIconTexture = this.SGameInstance.AssetDatabase.GetTexture("texture_icon_gui_14");
            this.penIconTexture = this.SGameInstance.AssetDatabase.GetTexture("texture_icon_gui_19");
            this.infoIconTexture = this.SGameInstance.AssetDatabase.GetTexture("texture_icon_gui_28");
            this.speedIconTextures = [
                this.SGameInstance.AssetDatabase.GetTexture("texture_icon_gui_44"),
                this.SGameInstance.AssetDatabase.GetTexture("texture_icon_gui_45"),
                this.SGameInstance.AssetDatabase.GetTexture("texture_icon_gui_46"),
            ];
