...
namespace StardustSandbox.Core.GUISystem.GUIs.Hud.Complements.PenSettings
{
    internal sealed partial class SGUI_PenSettings : SGUISystem
    {
        ...
        internal SGUI_PenSettings(ISGame gameInstance, string identifier, SGUIEvents guiEvents, SGUI_HUD guiHUD, SGUITooltipBoxElement tooltipBoxElement) : base(gameInstance, identifier, guiEvents)
        {
            ...
            this.panelBackgroundTexture = gameInstance.AssetDatabase.GetTexture("texture_gui_background_8");
            this.guiSmallButtonTexture = gameInstance.AssetDatabase.GetTexture("texture_gui_button_1");
            this.guiSliderTexture = gameInstance.AssetDatabase.GetTexture("texture_gui_slider_1");
            this.bigApple3PMSpriteFont = gameInstance.AssetDatabase.GetSpriteFont("font_2");

            this.guiHUD = guiHUD;

            this.eraserIconTexture = gameInstance.AssetDatabase.GetTexture("texture_icon_gui_4");
            this.exitIconTexture = gameInstance.AssetDatabase.GetTexture("texture_icon_gui_16");
            this.penIconTexture = gameInstance.AssetDatabase.GetTexture("texture_icon_gui_19");
            this.bucketIconTexture = gameInstance.AssetDatabase.GetTexture("texture_icon_gui_20");
            this.replacementIconTexture = gameInstance.AssetDatabase.GetTexture("texture_icon_gui_21");
            this.frontLayerIconTexture = gameInstance.AssetDatabase.GetTexture("texture_icon_gui_22");
            this.backLayerIconTexture = gameInstance.AssetDatabase.GetTexture("texture_icon_gui_23");
            this.squareShapeIconTexture = gameInstance.AssetDatabase.GetTexture("texture_icon_gui_24");
            this.circleShapeIconTexture = gameInstance.AssetDatabase.GetTexture("texture_icon_gui_25");
            this.triangleShapeIconTexture = gameInstance.AssetDatabase.GetTexture("texture_icon_gui_26");
            this.eyeIconTexture = gameInstance.AssetDatabase.GetTexture("texture_icon_gui_27");
