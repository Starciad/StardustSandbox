...
namespace StardustSandbox.Core.GUISystem.GUIs.Hud.Complements.EnvironmentSettings
{
    internal sealed partial class SGUI_EnvironmentSettings : SGUISystem
    {
        ...
        internal SGUI_EnvironmentSettings(ISGame gameInstance, string identifier, SGUIEvents guiEvents, SGUITooltipBoxElement tooltipBoxElement) : base(gameInstance, identifier, guiEvents)
        {
            ...
            this.panelBackgroundTexture = gameInstance.AssetDatabase.GetTexture("texture_gui_background_7");
            ...
            this.frozenTimeIconTexture = gameInstance.AssetDatabase.GetTexture("texture_icon_gui_29");
            this.timeProgressIconTexture = gameInstance.AssetDatabase.GetTexture("texture_icon_gui_30");
            this.midnightIconTexture = gameInstance.AssetDatabase.GetTexture("texture_icon_gui_31");
            this.dawnIconTexture = gameInstance.AssetDatabase.GetTexture("texture_icon_gui_32");
            this.morningIconTexture = gameInstance.AssetDatabase.GetTexture("texture_icon_gui_33");
            this.noonIconTexture = gameInstance.AssetDatabase.GetTexture("texture_icon_gui_34");
            this.afternoonIconTexture = gameInstance.AssetDatabase.GetTexture("texture_icon_gui_35");
            this.duskIconTexture = gameInstance.AssetDatabase.GetTexture("texture_icon_gui_36");
            this.eveningIconTexture = gameInstance.AssetDatabase.GetTexture("texture_icon_gui_37");
