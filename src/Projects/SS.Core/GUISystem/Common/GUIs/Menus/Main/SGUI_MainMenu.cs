...
namespace StardustSandbox.GameContent.GUISystem.GUIs.Menus.Main
{
    internal sealed partial class SGUI_MainMenu : SGUISystem
    {
        ...
        internal SGUI_MainMenu(ISGame gameInstance, string identifier, SGUIEvents guiEvents) : base(gameInstance, identifier, guiEvents)
        {
            ...
            this.particleTexture = this.SGameInstance.AssetDatabase.GetTexture("texture_particle_1");
            this.prosceniumCurtainTexture = this.SGameInstance.AssetDatabase.GetTexture("texture_miscellany_1");
