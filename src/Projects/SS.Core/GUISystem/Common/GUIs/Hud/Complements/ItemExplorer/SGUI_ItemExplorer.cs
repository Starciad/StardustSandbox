...
namespace StardustSandbox.GameContent.GUISystem.GUIs.Hud.Complements.ItemExplorer
{
    internal sealed partial class SGUI_ItemExplorer : SGUISystem
    {
        ...
        public SGUI_ItemExplorer(ISGame gameInstance, string identifier, SGUIEvents guiEvents, SGUI_HUD guiHUD, SGUITooltipBoxElement tooltipBoxElementElement) : base(gameInstance, identifier, guiEvents)
        {
            ...
            this.panelBackgroundTexture = gameInstance.AssetDatabase.GetTexture("texture_gui_background_12");
            ...
            this.rightIconTexture = gameInstance.AssetDatabase.GetTexture("texture_icon_gui_48");
            this.leftIconTexture = gameInstance.AssetDatabase.GetTexture("texture_icon_gui_50");
