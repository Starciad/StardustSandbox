    ...
    internal static class AssetDatabase
    {
        ...
        internal static void Load(ContentManager contentManager, GraphicsDevice graphicsDevice)
        {
            ...
            textures = [
                ...
                contentManager.Load<Texture2D>(Path.Combine("textures", "gui", "backgrounds", "achievements")),
                ...
                contentManager.Load<Texture2D>(Path.Combine("textures", "gui", "backgrounds", "item_search")),
