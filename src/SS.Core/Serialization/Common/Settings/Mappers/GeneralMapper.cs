...
{
    internal sealed class GeneralMapper : IMapper
    {
        public IData ToData(IStorageModel value)
        {
            GeneralStorageModel storageModel = (GeneralStorageModel)value;

            return new GeneralData()
            {
                Language = storageModel.Language,
        ...
        {
            GeneralData data = (GeneralData)value;

            return new GeneralStorageModel()
            {
