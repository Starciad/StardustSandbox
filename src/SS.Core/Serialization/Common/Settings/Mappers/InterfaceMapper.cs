...
{
    internal sealed class InterfaceMapper : IMapper
    {
        public IData ToData(IStorageModel value)
        {
            InterfaceStorageModel storageModel = (InterfaceStorageModel)value;

            return new InterfaceData()
            {
                ShowTooltip = storageModel.ShowTooltip
            };
        }

        public IStorageModel ToStorageModel(IData value)
        {
            InterfaceData data = (InterfaceData)value;

            return new InterfaceStorageModel()
            {
