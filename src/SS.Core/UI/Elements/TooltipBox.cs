...
namespace StardustSandbox.Core.UI.Elements
{
    internal sealed class TooltipBox : UIElement
    {
        ...
        private readonly InterfaceStorageModel interfaceSettings;

        internal TooltipBox(AssetDatabase assetDatabase, CursorManager cursorManager, GameScreen gameScreen, InterfaceStorageModel interfaceSettings)
        {
