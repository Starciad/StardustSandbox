...
namespace StardustSandbox.Core.UI.Common
{
    ...
    {
        internal SelectorUI(SelectorUIDependencies dependencies, UIElementHandler elementHandler, GameScreen gameScreen) : base(dependencies, elementHandler, gameScreen)
        {
