...
namespace StardustSandbox.Core.UI.Common
{
    ...
    {
        internal SelectorUI(SelectorUIDependencies dependencies, GameScreen gameScreen, UIElementHandler elementHandler) : base(dependencies, gameScreen, elementHandler)
        {
