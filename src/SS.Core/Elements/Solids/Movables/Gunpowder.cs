...
namespace StardustSandbox.Core.Elements.Solids.Movables
{
    internal sealed class Gunpowder : MovableSolid
    {
        ...
        internal Gunpowder(ElementIndex index, ElementCategory category, ElementRenderingType renderingType, Point textureOriginOffset, Color referenceColor) : base(index, category, renderingType, textureOriginOffset, referenceColor)
        {
