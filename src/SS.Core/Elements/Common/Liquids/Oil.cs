...
namespace StardustSandbox.Core.Elements.Common.Liquids
{
    ...
    {
        internal Oil(ElementIndex index, ElementCategory category, ElementRenderingProfile renderingProfile, GameEvents gameEvents) : base(index, category, renderingProfile, gameEvents)
        {
