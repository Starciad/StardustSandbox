...
namespace StardustSandbox.Core.Elements.Common.Solids.Movables
{
    internal sealed class Gunpowder : MovableSolid
    {
        ...
        internal Gunpowder(ElementIndex index, ElementCategory category, ElementRenderingProfile renderingProfile, GameEvents gameEvents) : base(index, category, renderingProfile, gameEvents)
        {
