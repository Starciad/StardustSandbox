...
namespace StardustSandbox.Core.Elements.Common.Solids.Immovables
{
    ...
    {
        internal Wood(ElementIndex index, ElementCategory category, ElementRenderingProfile renderingProfile, GameEvents gameEvents) : base(index, category, renderingProfile, gameEvents)
        {
