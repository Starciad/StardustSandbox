...
namespace StardustSandbox.Core.Elements.Common.Gases
{
    internal abstract class Gas : Element
    {
        ...
        internal Gas(ElementIndex index, ElementCategory category, ElementRenderingProfile renderingProfile, GameEvents gameEvents) : base(index, category, renderingProfile, gameEvents)
        {
