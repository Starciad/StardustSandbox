...
namespace StardustSandbox.Core.Elements.Common.Gases
{
    ...
    {
        internal AntiCorruption(ElementIndex index, ElementCategory category, ElementRenderingProfile renderingProfile, GameEvents gameEvents) : base(index, category, renderingProfile, gameEvents)
        {
