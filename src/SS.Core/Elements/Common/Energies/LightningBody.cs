...
namespace StardustSandbox.Core.Elements.Common.Energies
{
    internal sealed class LightningBody : Energy
    {
        ...
        internal LightningBody(ElementIndex index, ElementCategory category, ElementRenderingProfile renderingProfile, GameEvents gameEvents) : base(index, category, renderingProfile, gameEvents)
        {
