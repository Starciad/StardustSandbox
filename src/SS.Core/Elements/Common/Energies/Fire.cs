...
namespace StardustSandbox.Core.Elements.Common.Energies
{
    ...
    {
        internal Fire(ElementIndex index, ElementCategory category, ElementRenderingProfile renderingProfile, GameEvents gameEvents) : base(index, category, renderingProfile, gameEvents)
        {
