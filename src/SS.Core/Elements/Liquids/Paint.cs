...
namespace StardustSandbox.Core.Elements.Liquids
{
    internal sealed class Paint : Liquid
    {
        ...
        internal Paint(ElementIndex index, ElementCategory category, ElementRenderingType renderingType, Point textureOriginOffset, Color referenceColor, AchievementManager achievementManager) : base(index, category, renderingType, textureOriginOffset, referenceColor, achievementManager)
        {
