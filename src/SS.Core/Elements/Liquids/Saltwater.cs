...
namespace StardustSandbox.Core.Elements.Liquids
{
    ...
    {
        internal Saltwater(ElementIndex index, ElementCategory category, ElementRenderingType renderingType, Point textureOriginOffset, Color referenceColor, AchievementManager achievementManager) : base(index, category, renderingType, textureOriginOffset, referenceColor, achievementManager)
        {
            this.BaseDispersionRate = 3;
            this.InitialTemperature = 25.0f;
            this.BaseDensity = 1.03f;
