...
namespace StardustSandbox.Core.Constants
{
    public static class STimeConstants
    {
        ...
        public const float DEFAULT_NORMAL_SECONDS_PER_FRAMES = 02f;
        public const float DEFAULT_FAST_SECONDS_PER_FRAMES = 08f;
        public const float DEFAULT_VERY_FAST_SECONDS_PER_FRAMES = 16f;
